...
Now that we know why you should use R, what are the main steps of analyzing data? My typical analytical workflow follows these 7 steps:
  ...
  * **3. [Explore](https://craig.rbind.io/post/2020-12-07-asgr-3-0-exploring-data-with-elucidate/) the data** using descriptive summary statistics and visualizations.
