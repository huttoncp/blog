...
Click [here](https://craig.rbind.io/post/2020-10-10-asgr-2-5-dates/) to go back to the previous post on dates and times. Click [here](2021-04-25-asgr-3-1-data-visualization/) to go to the next one, on intermediate data visualization with the the popular tidyverse package [ggplot2](https://ggplot2.tidyverse.org/).
